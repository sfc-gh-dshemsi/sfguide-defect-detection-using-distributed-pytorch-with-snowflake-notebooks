...
-- Grant all privileges on database and schemas to the role
GRANT ALL PRIVILEGES ON DATABASE PCB_DATASET TO ROLE PCB_DEFECT_DETECTION_ROLE;
GRANT ALL PRIVILEGES ON SCHEMA PCB_DATASET.PCB_SCHEMA TO ROLE PCB_DEFECT_DETECTION_ROLE;
GRANT ALL PRIVILEGES ON SCHEMA PCB_DATASET.PUBLIC TO ROLE PCB_DEFECT_DETECTION_ROLE;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA PCB_DATASET.PCB_SCHEMA TO ROLE PCB_DEFECT_DETECTION_ROLE;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA PCB_DATASET.PUBLIC TO ROLE PCB_DEFECT_DETECTION_ROLE;
GRANT ALL PRIVILEGES ON ALL STAGES IN SCHEMA PCB_DATASET.PCB_SCHEMA TO ROLE PCB_DEFECT_DETECTION_ROLE;
GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA PCB_DATASET.PCB_SCHEMA TO ROLE PCB_DEFECT_DETECTION_ROLE;
GRANT ALL PRIVILEGES ON FUTURE TABLES IN SCHEMA PCB_DATASET.PUBLIC TO ROLE PCB_DEFECT_DETECTION_ROLE;

-- Grant warehouse and compute pool usage
GRANT USAGE ON WAREHOUSE PCB_WH TO ROLE PCB_DEFECT_DETECTION_ROLE;
...
GRANT USAGE ON COMPUTE POOL PCB_GPU_POOL TO ROLE PCB_DEFECT_DETECTION_ROLE;
GRANT MONITOR ON COMPUTE POOL PCB_GPU_POOL TO ROLE PCB_DEFECT_DETECTION_ROLE;
